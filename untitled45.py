# -*- coding: utf-8 -*-
"""
Created on Mon Jun  8 18:12:21 2026
...
#Automobile manufacturers and automotive analysts want to understand how vehicle characteristics such as horsepower, engine volume, speed, and weight influence fuel efficiency (MPG).
#Fuel efficiency is a critical factor affecting customer purchase decisions, regulatory compliance, and environmental impact.
...
MPG             Miles per gallon(fuel efficiency)   Numeric   Target variable
HP              Horsepower of vehicle               Numeric   Indicates engine power
VOL             Engine valume                       Numeric   Reflects engine power
SP              Maximum speed                       Numeric   Performance indicators
WT              Vehicle weight                      Numeric   Influence fuel consumption
'''
########################
